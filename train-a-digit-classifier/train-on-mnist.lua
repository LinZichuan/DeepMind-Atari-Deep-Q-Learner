...
function train(dataset)
  ...
  local k = 1
  -- create mini batch according to the ./save/ACTION
  local indices = torch.load('../save/ACTION')
...
-- train/test
train(trainData)
print('after training a mini-batch, save the state......')
local p,g = model:getParameters()
local state = model.modules[4].weight
torch.save('../save/NEXT_STATE', state)
test(testData)
